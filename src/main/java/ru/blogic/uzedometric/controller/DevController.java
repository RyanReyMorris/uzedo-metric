...
public class DevController {
    ...
    public ResponseEntity<String> getGpnMetrics() {
        return ResponseEntity.ok(metricService.peek(Project.GPN));
    }
    ...
    public ResponseEntity<String> getVtblMetrics() {
        return ResponseEntity.ok(metricService.peek(Project.VTBL));
    }
    ...
    public ResponseEntity<String> getRnMetrics() {
        return ResponseEntity.ok(metricService.peek(Project.RN));
    }
    ...
    public ResponseEntity<String> getVankorMetrics() {
        return ResponseEntity.ok(metricService.peek(Project.VANKOR));
    }
}
